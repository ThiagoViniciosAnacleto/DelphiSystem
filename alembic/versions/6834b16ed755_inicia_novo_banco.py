...
Revision ID: 6834b16ed755
Revises: 
Create Date: 2026-06-09 09:03:45.855374
...
def upgrade() -> None:
    ...
    sa.Column('datetime_abertura', sa.DateTime(timezone=True), nullable=False),
    sa.Column('contato', sa.String(length=150), nullable=False),
    ...
    sa.Column('data_interacao', sa.DateTime(timezone=True), nullable=False),
